 ...
 * @param 		None
 * @return 		None
 * @note 			This function resets all of the previous DMA configurations, be carefull and be sure you have called 
 * 						this function only ONCE @ the start of application 			
 *********************************************************************/
void GPDMA_Init(void)
{
	static volatile uint8_t global_init_done = FALSE;	// To be sure this function will be called only ONCE,
																											// during application life-cycle //	
	if(TRUE == global_init_done)
		return;
	/* Enable GPDMA clock */
