...
#define AZP_SOFTWARE_VERSION	100
...
typedef enum
{
	...
	ST_AZP_FAST,		// AZP Fast Boxes' State // 
...
typedef __packed union {
	__packed struct {	// Dont change the order of components,
		...
		uint16_t AZPFastState;	// AZP Fast Screen Boxes' State // 

		uint16_t Crc16;	
	}str;
	__packed uint16_t Settings[ST_COUNT];
} uAppStore;
#define APP_SETTING_STRUCT_VERSION		(102)
typedef struct {
...
#define APP_LOG_LEVEL						FATAL_LEVEL
...
#define JACK_DETECT_FILTER_TAP_COUNT		21
...
#define ID_TIMER_A5P_LOAD_ANIM            ID_TIMER_SCREEN_ANIM
#define ID_TIMER_AZP_LOAD_ANIM            ID_TIMER_SCREEN_ANIM
#define ID_TIMER_AZP_GB_ANIM            ID_TIMER_SCREEN_ANIM
...
#define GUI_TASK_MESSAGE_QUEUE_SIZE		(20)		// GUI task message queue maximum message count //  
...
// SOFTWARE TIMREs //
#define COMM_RSP_TIMEOUT_FR_TMR_INDX		0
#define COMM_RSP_TIMEOUT_FR_TMR_CMD_BLOCK_MS	100
...
extern void start_dac_playing(uint32_t freq_multipler);
...
// SYS LOADING SCREEN EVENTs // 
#define SYS_LOADING_SENSE_CMD_SEND_INDX				0
#define SYS_LOADING_SENSE_RSP_RECEIVED_INDX			1
#define SYS_LOADING_GID_CMD_SEND_INDX				2
#define SYS_LOADING_GID_RSP_RECEIVED_INDX			3
#define SYS_LOADING_FERRO_CMD_SEND_INDX				4
#define SYS_LOADING_FERRO_RSP_RECEIVED_INDX			5
#define SYS_LOADING_CLOCK_SET_CMDs_RECEIVED_INDX	6
#define SYS_LOADING_INIT_DONE_RECEIVED_INDX			7
#define SYS_LOAD_ICON_COUNT			8

// AZP SETTINGs (COMMON for DISC, ALLMETAL, FAST) // 
#define AZP_BACKGROUND_COLOR		0x00FFDACC	
#define A5P_BACKGROUND_COLOR_ALLM	0x00FFDACC	
#define A5P_BACKGROUND_COLOR_OTO	GUI_LIGHTBLUE
#define A5P_BACKGROUND_COLOR_DISC	0x00EEBABB
#define AZP_ACTIVE_AREA_COLOR		GUI_WHITE
#define AZP_LINE_WIDTH	4

#define AZP_SCR_STR_UPX		(GLCD_X_SIZE/6)
#define AZP_SCR_STR_UPY		SB_FULL_TOP_SIZE_Y
#define AZP_SCR_STR_DOWNX	(5*(GLCD_X_SIZE/6))
#define AZP_SCR_STR_DOWNY	(2*(GLCD_Y_SIZE/6))

typedef enum {
	SEARCH_START_REQUESTED = 0,
	SEARCH_STARTED,
